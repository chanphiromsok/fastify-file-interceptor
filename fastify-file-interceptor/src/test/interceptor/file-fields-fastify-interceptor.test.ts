...
import { FileFieldsFastifyInterceptor } from "../../multer/interceptor/file-fields-fastify-interceptor";
import { of } from "rxjs";
import * as sinon from "sinon";

describe("FileFieldsInterceptor", () => {
  it("should return metatype with expected structure", async () => {
    const targetClass = FileFieldsFastifyInterceptor([
  ...
  describe("intercept", () => {
    ...
    it("should call object with expected params", async () => {
      ...
      const target = new (FileFieldsFastifyInterceptor(argument))();
