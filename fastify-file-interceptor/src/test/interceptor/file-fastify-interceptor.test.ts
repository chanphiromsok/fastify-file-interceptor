...
import { FileFastifyInterceptor } from "../../multer/interceptor/file-fastify-interceptor";

describe("FileInterceptor", () => {
  it("should return metatype with expected structure", async () => {
    const targetClass = FileFastifyInterceptor("file");
  ...
  describe("intercept", () => {
    ...
    it("should call single() with expected params", async () => {
      ...
      const target = new (FileFastifyInterceptor(fieldName))();
